...
<%
    ...
    int bid = Integer.parseInt(request.getParameter("b_id").toString());
...
<!-- 		TRIED TO DYNAMICALLY CREATE BUTTONS BUT ONCLICK WAS NOT SET CORRECTLY
            ...
            <!--By default 25 buttons taken-->
        <table class="mytable">
            <tr>
            <th><button type="button" id="1" class="button" onclick="buttonClickCount(1)">1</button></th>
            <th><button type="button" id="2" class="button" onclick="buttonClickCount(2)">2</button></th>
            <th><button type="button" id="3" class="button" onclick="buttonClickCount(3)">3</button></th>
            <th><button type="button" id="4" class="button" onclick="buttonClickCount(4)">4</button></th>
            <th><button type="button" id="5" class="button" onclick="buttonClickCount(5)">5</button></th>
            <th><button type="button" id="6" class="button" onclick="buttonClickCount(6)">6</button></th>
            <th><button type="button" id="7" class="button" onclick="buttonClickCount(7)">7</button></th>
            <th><button type="button" id="8" class="button" onclick="buttonClickCount(8)">8</button></th>
            <th><button type="button" id="9" class="button" onclick="buttonClickCount(9)">9</button></th>
            <th><button type="button" id="10" class="button" onclick="buttonClickCount(10)">10</button></th>
            <th><button type="button" id="11" class="button" onclick="buttonClickCount(11)">11</button></th>
            <th><button type="button" id="12" class="button" onclick="buttonClickCount(12)">12</button></th>
            </tr>
            <tr>
            <th colspan="12"><button type="button" id="14" class="button" onclick="buttonClickCount(14)" style="float: right">13</button></th>
            </tr>
            <tr>
            <th><button type="button" id="14" class="button" onclick="buttonClickCount(14)">14</button></th>
            <th><button type="button" id="15" class="button" onclick="buttonClickCount(15)">15</button></th>
            <th><button type="button" id="16" class="button" onclick="buttonClickCount(16)">16</button></th>
            <th><button type="button" id="17" class="button" onclick="buttonClickCount(17)">17</button></th>
            <th><button type="button" id="18" class="button" onclick="buttonClickCount(18)">18</button></th>
            <th><button type="button" id="19" class="button" onclick="buttonClickCount(19)">19</button></th>
            <th><button type="button" id="20" class="button" onclick="buttonClickCount(20)">20</button></th>
            <th><button type="button" id="21" class="button" onclick="buttonClickCount(21)">21</button></th>
            <th><button type="button" id="22" class="button" onclick="buttonClickCount(22)">22</button></th>
            <th><button type="button" id="23" class="button" onclick="buttonClickCount(23)">23</button></th>
            <th><button type="button" id="24" class="button" onclick="buttonClickCount(24)">24</button></th>
            <th><button type="button" id="13" class="button" onclick="buttonClickCount(25)">25</button></th>
            </tr>
            <%
		...
		<button type="button" id="proceed" onclick="final()">Proceed</button>
                <script>
                        ...
                        function final(){
                            ...
                            window.location="http://localhost:8080/Final/proceed.jsp?finalSeats="+finalSeats;
                            }
